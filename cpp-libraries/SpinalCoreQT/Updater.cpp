...
void Updater::exec( const ModelPointer &mp ) {
    // nothing to compute ?
...
void Updater::clear_error_list( const ModelPointer &mp ) {
    mp[ "_messages" ].clear();
}

bool Updater::add_message( const ModelPointer &mp, ErrorType type, QString title ) {

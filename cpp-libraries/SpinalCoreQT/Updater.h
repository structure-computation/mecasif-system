...
public:
    ...
    void exec( const ModelPointer &mp );
    bool add_message( const ModelPointer &mp, ErrorType type, QString title );

protected:
    void clear_error_list( const ModelPointer &mp );
    virtual bool run( ModelPointer mp ) = 0;
